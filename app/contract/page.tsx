  ...
  <div className="relative flex flex-col items-center px-6 pb-6">
    <div className="-mt-16 mb-4">
      <img className="w-28 h-28 rounded-full border-4 border-white dark:border-slate-800 shadow-md object-cover"
           src="\images\Tawan01.jpg"
           alt=""/>
    </div>
   
    <h3 className="text-xl font-bold text-slate-800 dark:text-white">Jakkapat Kumsom</h3>
    <p className="text-sm text-blue-600 dark:text-blue-400 font-medium">Web Developer</p>
    <p className="text-sm text-slate-500 dark:text-slate-400 text-center mt-3">
     อาศัยอยู่ที่กรุงเทพมหานครในประเทศไทย ศึกษษเล่าเรียนที่มหาวิทยาลัยเทคโนโลยีราชมงคลตะวันออกวิทยาเขตจักรพงภูวนาถ
    </p>
    ...
    <div className="mt-6 flex gap-3">
      ...
      href="mailto:tawanrewqa@gmail.com"
      target="blank">
        Gmail
      </a>
      ...
      href="https://github.com/Akalotz/Tawan-app"
      target="blank">
        GitHub
      </a>
    </div>
